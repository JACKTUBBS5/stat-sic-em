...
title2 'Using CART and RF'; 


proc hpsplit data=wines_red assignmissing=similar cvmodelfit  seed=123 MINLEAFSIZE=10;
   class  r_quality;
...
proc hpforest data=wines_red maxtrees=30 INBAGFRACTION=.5 ;
...
title3 'Predicted Survival';
proc sgplot data=ldata.score;
vbox P_r_quality1/group=r_quality;
run;
...
proc logistic data=wines_red  plots=(roc effect);
